...
public class Student {
    ...
    public String toString() {
        return "id: " + this.id + ", firstName: " + this.firstName + ", lastName: " + this.lastName + ", averageGrade: " + this.averageGrade;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int)Double.doubleToLongBits(this.averageGrade);
